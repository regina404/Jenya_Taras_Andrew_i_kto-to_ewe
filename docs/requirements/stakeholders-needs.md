...
5) Система формує список користувачів які не є модераторами або адмінастраторами
6) Адміністратор обирає користувача
7) Система змінює статус обраного користувача на модератора
...
2) Система перенаправляє користувача на сторінку для заповнення даних входу
3) Система перевіряє дані введені користувачем,якщо дані коректні надає користувачу можливості адміністратора
4) Адміністратор обирає функцію видалити модератора
5) Система формує список модераторів
6) Адміністратор обирає  модератора котрого буде видалено
7) Система змінює статус обраного модератора на користувача
