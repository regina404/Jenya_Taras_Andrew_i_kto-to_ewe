...
Маємо 3  категорій зацікавлених осіб: користувач, модератор та адміністратор.
...
- переглядати, змінювати та видаляти об’яви.
